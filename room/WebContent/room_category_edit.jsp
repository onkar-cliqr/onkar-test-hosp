...
<head>
    ...
    <title>Room Category Details|Hospital Checklist</title>
...
%>
  ...
  $(document).ready(function(){ 
	  rooms_category_id=$.urlParam('rooms_category_id');
 	  if(rooms_category_id &&  rooms_category_id != 'undefined')
  	$.ajax({
  		  type: 'GET',
  		  url: 'get?table=room_category&query=id='+rooms_category_id+' or active=false',
...
<button class="btn btn-darkgrey" id="cancel">Back</button>
    ...
    function submit(){
    	  ...
    	  $.ajax({
    		  ...
    		  contentType: 'application/json; charset=utf-8',
    		  dataType: 'json',
    		  url: "post?table=room_category",
    		  data: JSON.stringify(formDataObj),
    		  success: function( data, textStatus, jQxhr ){
    			  successdailog("room_category.jsp");
                    //document.location="room_category.jsp";
                },
    ...
    function deleterecord(){
	  $.ajax({
		  ...
		  contentType: 'application/json; charset=utf-8',
		  dataType: 'json',
		  url: "post?table=room_category&id="+rooms_category_id,
		  success: function( data, textStatus, jQxhr ){
			  	alert(data.msg);
                document.location="room_category.jsp";
            },
