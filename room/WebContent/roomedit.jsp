...
<head>
    ...
    <title>Rooms Details|Hospital Checklist</title>
...
if(route){
  ...
  $(document).ready(function(){ 
  	...
  	$.ajax({
  		  type: 'GET',
  		  url: 'get?table=rooms&query=id='+room_id,
...
<button class="btn btn-darkgrey" id="cancel">Back</button>
    ...
    function submit(){
    	  ...
    	  $.ajax({
    		  ...
    		  contentType: 'application/json; charset=utf-8',
    		  dataType: 'json',
    		  url: "post?table=rooms",
    		  data: JSON.stringify(formDataObj),
    		  success: function( data, textStatus, jQxhr ){
    			  	successdailog("room.jsp");
                },
    ...
    function deleterecord(){
	  $.ajax({
		  ...
		  contentType: 'application/json; charset=utf-8',
		  dataType: 'json',
		  url: "post?table=rooms&id="+room_id,
		  success: function( data, textStatus, jQxhr ){
			  	alert(data.msg);
