...
<head>
    ...
    <title>Room Category List|Hospital Checklist</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			$.ajax({
	    		  type: 'GET',
	    		  url: 'get?table=room_category&query=active=false or active =false or active =true',
	    		  ...
	    		  success: function(jsonData) {
	    			  ...
	    			  for(var i=0;i<jsonData.length;i++){
	    				  ...
	    				  '<td class="col1"><a href="#" onclick="navigateTorooms_category_edit(\''+jsonData[i].id+'\')">'+jsonData[i].name+'</a></td>';
        ...
        <div class="clear">
         ...
         <div class="grid_10">
            <div class="box round first grid">
                <h2>
                    List of Check List  <button onclick="navigateTorooms_category_edit()" class="btn btn-darkgrey" id="addnewuser">New Check List</button></h2>
