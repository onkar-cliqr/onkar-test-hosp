...
<head>
    ...
    <title>User List|Hospital Checklist</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			$.ajax({
	    		  type: 'GET',
	    		  url: 'get?table=users&query=id!=2 or active=false',
	    		  ...
	    		  success: function(jsonData) {
	    			  ...
	    			  for(var i=0;i<jsonData.length;i++){
	    				  ...
	    				  '<td class="col1"><a href="#" onclick="navigateTousersedit(\''+jsonData[i].id+'\')">'+jsonData[i].name+'</a></td>';
        ...
        <div class="clear">
         ...
         <div class="grid_10">
            <div class="box round first grid">
                <h2>
                    List of Users  <button onclick="navigateTousersedit()" class="btn btn-darkgrey" id="addnewuser">New User</button></h2>
